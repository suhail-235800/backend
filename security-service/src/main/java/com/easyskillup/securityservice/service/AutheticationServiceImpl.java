...
public class AutheticationServiceImpl implements AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        ...
        return new AuthenticationResponse(request.role(),token,user.getId());
    }
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
        ...
        return new AuthenticationResponse(jwtService.generateToken(Map.of("roles", authorities),user),role,user.getId());
    }
}
